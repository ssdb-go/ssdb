...
type data struct {
	...
	String  string  `ssdb:"string"`
	Bytes   []byte  `ssdb:"byte"`
	Int     int     `ssdb:"int"`
	Int8    int8    `ssdb:"int8"`
	Int16   int16   `ssdb:"int16"`
	Int32   int32   `ssdb:"int32"`
	Int64   int64   `ssdb:"int64"`
	Uint    uint    `ssdb:"uint"`
	Uint8   uint8   `ssdb:"uint8"`
	Uint16  uint16  `ssdb:"uint16"`
	Uint32  uint32  `ssdb:"uint32"`
	Uint64  uint64  `ssdb:"uint64"`
	Float   float32 `ssdb:"float"`
	Float64 float64 `ssdb:"float64"`
	Bool    bool    `ssdb:"bool"`
}
