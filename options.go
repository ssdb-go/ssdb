...
// ParseURL parses an URL into Options that can be used to connect to ssdb.
// Scheme is required.
...
func ParseURL(ssdbURL string) (*Options, error) {
	...
	default:
		return nil, fmt.Errorf("ssdb: invalid URL scheme: %s", u.Scheme)
	}
}
...
func setupTCPConn(u *url.URL) (*Options, error) {
	...
	case 1:
		if o.DB, err = strconv.Atoi(f[0]); err != nil {
			return nil, fmt.Errorf("ssdb: invalid database number: %q", f[0])
		}
	default:
		return nil, fmt.Errorf("ssdb: invalid URL path: %s", u.Path)
	}
...
func setupUnixConn(u *url.URL) (*Options, error) {
	...
	if strings.TrimSpace(u.Path) == "" { // path is required with unix connection
		return nil, errors.New("ssdb: empty unix socket path")
	}
	o.Addr = u.Path
	o.Username, o.Password = getUserPassword(u)
	return setupConnParams(u, o)
...
func (o *queryOptions) int(name string) int {
	...
	if o.err == nil {
		o.err = fmt.Errorf("ssdb: invalid %s number: %s", name, err)
	}
	return 0
}
...
func (o *queryOptions) duration(name string) time.Duration {
	...
	if o.err == nil {
		o.err = fmt.Errorf("ssdb: invalid %s duration: %w", name, err)
	}
	return 0
}
...
func (o *queryOptions) bool(name string) bool {
	...
	default:
		if o.err == nil {
			o.err = fmt.Errorf("ssdb: invalid %s boolean: expected true/false/1/0 or an empty string, got %q", name, s)
		}
		return false
	}
}
...
func setupConnParams(u *url.URL, o *Options) (*Options, error) {
	...
	if tmp := q.string("db"); tmp != "" {
		...
		if err != nil {
			return nil, fmt.Errorf("ssdb: invalid database number: %w", err)
		}
		o.DB = db
	}
	...
	if r := q.remaining(); len(r) > 0 {
		return nil, fmt.Errorf("ssdb: unexpected option: %s", strings.Join(r, ", "))
	}
